...
void init_entities(World* world) {
	...
	load_model("objects//clock.obj", &world->clock.model);
	world->clock.texture = load_texture("textures//clock.jpg");
	...
	world->ground = load_texture("textures//padlo.jpg");
	load_skybox(&world->skybox);
	print_model_info(&(world->clock.model));
